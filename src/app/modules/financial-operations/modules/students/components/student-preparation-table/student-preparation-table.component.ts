...
@Component({
  selector: 'app-student-preparation-table',
  templateUrl: './student-preparation-table.component.html',
  styleUrls: ['./student-preparation-table.component.scss']
})
export class StudentPreparationTableComponent implements OnInit {
  ...
  drawAgGrid(): void {
    if (!this.columnDefs.length) {
      this.columnDefs = [
        {
          headerName: this.translate.instant('AUTH.INPUT.USERNAME'),
          field: (this.translation.getSelectedLanguage()== 'ar') ? 'name_ar' : 'name_en',
          minWidth: 110,
        },
        {
          headerName: this.translate.instant('parent_pages.identification_number'),
          field: 'numAcademy',
          minWidth: 150
        },
        {
        ...
        {
          headerName: this.translate.instant('general.semaster'),
          field: 'class',
          minWidth: 150
        },
        {
          headerName: this.translate.instant('parent_pages.former_teacher'),
          field: 'type',
          minWidth: 150
        },
        {
          headerName: this.translate.instant('general.joining_date'),
          field: 'updated_at',
          minWidth: 150
        },
      ];
