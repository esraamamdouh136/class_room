...
@Component({
  selector: 'app-update-students-information',
  templateUrl: './update-students-information.component.html',
  styleUrls: ['./update-students-information.component.scss']
})
export class UpdateStudentsInformationComponent implements OnInit {
  semasters = [
    "الأول الابتدائي",
    "الثاني الابتدائي",
    "الثالث الابتدائي",
