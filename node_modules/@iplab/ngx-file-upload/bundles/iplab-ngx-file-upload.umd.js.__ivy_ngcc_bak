(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@angular/common'), require('@angular/forms'), require('@angular/animations'), require('rxjs')) :
    typeof define === 'function' && define.amd ? define('@iplab/ngx-file-upload', ['exports', '@angular/core', '@angular/common', '@angular/forms', '@angular/animations', 'rxjs'], factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory((global.iplab = global.iplab || {}, global.iplab['ngx-file-upload'] = {}), global.ng.core, global.ng.common, global.ng.forms, global.ng.animations, global.rxjs));
}(this, (function (exports, core, common, forms, animations, rxjs) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    FileUploadDropZoneComponent.decorators = [
        { type: core.Component, args: [{
