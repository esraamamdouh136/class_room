...
export declare class FileSizeValidator implements Validator, OnChanges {
    ...
    static ɵfac: ɵngcc0.ɵɵFactoryDef<FileSizeValidator, never>;
    static ɵdir: ɵngcc0.ɵɵDirectiveDefWithMeta<FileSizeValidator, "file-upload[filesize][formControlName],    file-upload[filesize][formControl],    file-upload[filesize][ngModel],    file-upload[minsize][formControlName],    file-upload[minsize][formControl],    file-upload[minsize][ngModel],    file-upload[maxsize][formControlName],    file-upload[maxsize][formControl],    file-upload[maxsize][ngModel]", never, { "filesize": "filesize"; "minsize": "minsize"; "maxsize": "maxsize"; }, {}, never>;
}
/**
...
export declare class FilesLimitValidator implements Validator, OnChanges {
    ...
    registerOnValidatorChange(fn: () => void): void;
    private _createValidator;
    static ɵfac: ɵngcc0.ɵɵFactoryDef<FilesLimitValidator, never>;
    static ɵdir: ɵngcc0.ɵɵDirectiveDefWithMeta<FilesLimitValidator, "file-upload[fileslimit][formControlName], file-upload[fileslimit][formControl], file-upload[fileslimit][ngModel]", never, { "fileslimit": "fileslimit"; }, {}, never>;
}
/**
...
export declare class FilesAcceptValidator implements Validator, OnChanges {
    ...
    registerOnValidatorChange(fn: () => void): void;
    private _createValidator;
    static ɵfac: ɵngcc0.ɵɵFactoryDef<FilesAcceptValidator, never>;
    static ɵdir: ɵngcc0.ɵɵDirectiveDefWithMeta<FilesAcceptValidator, "file-upload[accept][formControlName], file-upload[accept][formControl], file-upload[accept][ngModel]", never, { "accept": "accept"; }, {}, never>;
}
